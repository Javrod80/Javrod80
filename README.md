...
Recientemente he finalizado el curso de **Desarrollo de Aplicaciones con Tecnologías Web**, y completé mis prácticas profesionales como desarrollador **Full Stack**, donde participé en el desarrollo de una aplicación web para la localización de activos en tiempo real, utilizando tecnologías como **React**, **Node.js**, **MySQL**, **Sequelize** y **MQTT**.
